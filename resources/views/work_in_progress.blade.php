        ...
        <main class="col-md-12 px-md-4">
            <div class="card-main">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                    <h1 class="h2">Work in Progress Tickets</h1>
...
// $('body').on('click', '.ticketprogress', function (e) {
//     alert('hi');
// });
$('body').on('click', '.ticketprogress', function () {

    var url = new URL("{{ url('showprogress') }}/"+$(this).closest("tr").find(".ticket_id").text());

   //url.searchParams.append('ticket_id', $(this).closest("tr").find(".ticket_id").text());
   ...
   // url.searchParams.append('ticket_id', $(this).closest("tr").find(".ticket_id").text());
    ...
    // $.ajax({
    //     type:'get',
    //     url:"{{ url('showprogress') }}",
    //     data: $(this).closest("tr").find(".ticket_id").text(),
    //     dataType: 'html',
