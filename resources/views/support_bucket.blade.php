    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Support Bucket</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Support Bucket</h4>
                    </div>
                    <div class="card-body">
...
<script>
    ...
    $(document).ready(function () {
        ...
        columns: [
            ...
            {data: 'branch_code', name: 'branch_code', class:"hiddenField branch_code"},
