    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">My In Progress Tickets</a></li>
            </ol>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">My In Progress Tickets</h4>
                    </div>
                    <div class="card-body">
...
<script>
    ...
    $(document).ready(function () {
        ...
        columns: [
            ...
            {data: 'push_to', name: 'push_to',class:"push_to"},
